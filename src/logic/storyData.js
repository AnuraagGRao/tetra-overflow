...
export const STORY_CHAPTERS = [
    ...
    levels: [
      {
        ...
        bgType: 'quake', bpm: 80, gravityMult: 0.70, targetLines: 28, easyTargetLines: 20, themeUnlock: 'theme_terracotta',
      ...
      },
      {
        ...
        bgType: 'crystal', bpm: 95, gravityMult: 0.85, targetLines: 30, easyTargetLines: 22, themeUnlock: 'theme_amber',
      ...
      },
      {
        ...
        bgType: 'forest', bpm: 105, gravityMult: 1.00, targetLines: 32, easyTargetLines: 24,
      ...
      },
      {
        ...
        bgType: 'lava', bpm: 125, gravityMult: 1.20, targetLines: 36, easyTargetLines: 26, isBoss: true, themeUnlock: 'theme_obsidian', mechanic: 'screen_shake',
    ...
    levels: [
      {
        ...
        bgType: 'ocean', bpm: 70, gravityMult: 0.60, targetLines: 28, easyTargetLines: 20,
      ...
      },
      {
        ...
        bgType: 'bubbles', bpm: 110, gravityMult: 0.80, targetLines: 32, easyTargetLines: 24,
      ...
      },
      {
        ...
        bgType: 'glacier', bpm: 90, gravityMult: 1.10, targetLines: 36, easyTargetLines: 26, themeUnlock: 'theme_frozen',
      ...
      },
      {
        ...
        bgType: 'storm', bpm: 140, gravityMult: 1.40, targetLines: 40, easyTargetLines: 30, isBoss: true, themeUnlock: 'theme_biolume', mechanic: 'garbage_surge',
    ...
    levels: [
      {
        ...
        bgType: 'ember', bpm: 100, gravityMult: 0.90, targetLines: 30, easyTargetLines: 22, themeUnlock: 'theme_copper',
      ...
      },
      {
        ...
        bgType: 'lava', bpm: 115, gravityMult: 1.10, targetLines: 34, easyTargetLines: 24,
      ...
      },
      {
        ...
        bgType: 'volcano', bpm: 135, gravityMult: 1.35, targetLines: 38, easyTargetLines: 28,
      ...
      },
      {
        ...
        bgType: 'inferno', bpm: 160, gravityMult: 1.70, targetLines: 44, easyTargetLines: 32, isBoss: true, themeUnlock: 'theme_stained', mechanic: 'speed_spikes',
    ...
    levels: [
      {
        ...
        bgType: 'clouds', bpm: 85, gravityMult: 0.70, targetLines: 32, easyTargetLines: 24,
      ...
      },
      {
        ...
        bgType: 'storm', bpm: 130, gravityMult: 1.25, targetLines: 38, easyTargetLines: 28,
      ...
      },
      {
        ...
        bgType: 'aurora', bpm: 150, gravityMult: 1.50, targetLines: 44, easyTargetLines: 32, isBoss: true, themeUnlock: 'theme_ukiyo',
    ...
    levels: [
      {
        ...
        bgType: 'stars', bpm: 60, gravityMult: 0.50, targetLines: 34, easyTargetLines: 24,
      ...
      },
      {
        ...
        bgType: 'nebula', bpm: 90, gravityMult: 0.90, targetLines: 38, easyTargetLines: 28,
      ...
      },
      {
        ...
        bgType: 'warp', bpm: 140, gravityMult: 1.60, targetLines: 42, easyTargetLines: 30, mechanic: 'instant_drop_zones',
      ...
      },
      {
        ...
        bgType: 'blackhole', bpm: 170, gravityMult: 2.00, targetLines: 48, easyTargetLines: 34, isBoss: true, themeUnlock: 'theme_vaporwave', mechanic: 'gravity_well',
    ...
    levels: [
      {
        ...
        bgType: 'abyss', bpm: 50, gravityMult: 1.10, targetLines: 38, easyTargetLines: 28,
  ...
  // ── Chapter 7: CONVERGENCE (final — 5 levels) ─────────────────────────────
  {
    ...
    levels: [
      ...
      },
      {
        ...
        bgType: 'blackhole', bpm: 190, gravityMult: 2.20, targetLines: 50, easyTargetLines: 36,
  ...
  // ── Secret Chapter: THE MATRIX (appears at the top once all seals break) ──
  {
    id: 'ch8', title: 'THE MATRIX', subtitle: 'There is no cake.',
    mapX: 95, mapY: 2, color: '#00ff41', glowColor: '#00ff41',
    levels: [
      {
